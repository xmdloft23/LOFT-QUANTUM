...
// Attach call listener to the socket once (called from loft.js connection.open)
                ...
                try {
                    await sock.sendMessage(caller, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                title:        'Call Rejected',
                                body:         (getStr('botName') || 'LOFT-QUANTUM') + ' Anti-Call',
                                thumbnailUrl: getStr('pic1') || 'https://files.catbox.moe/d4nl2o.jpg',
                                mediaType:    1
                            }
                        }
                    });
