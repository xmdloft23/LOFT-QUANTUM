...
- **Web dashboard**: `smm/loft.html` — served via Express at port 5000
...
| File/Dir         | Purpose                                         |
|------------------|-------------------------------------------------|
| `index.js`       | Main entry — connects to WhatsApp, runs Express |
...
| `themes/`        | Theme JSON files (19 themes — Loft default)    |
...
| `smm/loft.html` | Admin dashboard (served as static file)         |

## Environment Variables

See `sample.env` for the full list. Key ones:

- `SESSION_ID` — WhatsApp session (required). Format: `Loft~<base64-gzip>`
...
| loft-ai | ai, gpt, chatgpt | public |
| loft-getjid | getjid, jid | public |
| loft-owner | owner, creator | public |
| loft-ping | ping | public |
| loft-shorturl | shorten | public |
| loft-uptime | uptime, runtime | public |
