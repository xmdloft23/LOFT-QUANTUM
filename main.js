...
const { handleChatbotMessage, group// ʟᴏꜰᴛ Qᴜᴀɴᴛᴜᴍ™
const fs = require('fs');
const path = require('path');
    ...
    try {
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.unban'):
                ...
                break;
            case userMessage === '.help' || userMessage === '.menu' || userMessage === '.bot' || userMessage ToggleCommand } = require('./loftcore/chatbot')
const takeCommand = require('./loftcore/take');
const { flirtCommand } = require('./loftcore/flirt');
const characterCommand = require('./loftcore/character');
const wastedCommand = require('./loftcore/wasted');
